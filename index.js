...
// Middlewares
app.use(express.json());
app.use(express.urlencoded({ extended: false })); // to read form encoded data

// Routes
app.use("/api/products", courseRoute);

app.get("/", (req, res) => {
  res.send("I am good, bendi!");
});
...
module.exports = (req, res) => {
  app(req, res);  // Express as a function handler for Vercel
};
